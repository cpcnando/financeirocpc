<?
    ...
    $_SESSION['ACESSO'] = 'Conta Corrente';
    include __DIR__."/../../sgbd/acesso.php";
?>
<div id="cpc-topo" class="card my-2">
    <div class="row card-head h5 text-center mt-1">
        <div class="col-12 d-flex justify-content-evenly">
            <button type="button" class="btn btn-outline-primary btn-sm cpcnoprint" data-bs-toggle="offcanvas" data-bs-target="#formestatistico_conta" aria-controls="formestatistico_conta">
            ...
            <div class="input-group justify-content-center">
                    ...
                    <input type="text" name="buscar" id="buscar" class="form-control form-control-sm cpcnoprint" onkeyup="filtraTabela($(this).val(),'estatistico_conta')" placeholder="Pesquisar..." style="min-width:200px; max-width:800px">
            </div>
...
<form id="formestatistico_conta" name="formestatistico_conta" action="." method="post" class="btn-group d-flex justify-content-between mb-3 offcanvas offcanvas-start" role="group" aria-label="Button group with nested dropdown" tabindex="-1" aria-labelledby="offcanvasLabel">
    <input type="hidden" name="tipodml" value="estatistico_conta">
    ...
    <div class="offcanvas-body">
        ...
        <div class="mt-4 d-flex justify-content-center">
            <button class="btn btn-outline-success w-100" id="estatistico_conta" onclick="sqlitem($('#formestatistico_conta'),'financeiro/relatorios/estatistico_conta','cpcMain');">Atualizar</button>
        </div>
    </div>
</form>

<div id="cpc-autoheight" style="overflow: auto;">
    <table id="estatistico_conta" class="container table table-hover table-sm tabelareport" style="min-width:1440px">
        ...
        <tbody id="cpc-autoheightgrid" class="text-gray-600 tabelabody">
            <?
                ...
                $sql = "select CONTAS.CONTA AS NUM, CONTAS.A_NOME AS CONTA, ". 
...
<div class="loadcpc" onclick="
  ...
  $('#formestatistico_conta').offcanvas('show');
"></div>
<? } ?>