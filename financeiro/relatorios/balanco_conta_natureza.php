<?
    ...
    $_SESSION['ACESSO'] = 'Balanço Conta por Natureza';
    include __DIR__."/../../sgbd/acesso.php";
?>
<div id="cpc-topo" class="card my-2">
    <div class="row card-head h5 text-center mt-1">
        <div class="col-12 d-flex justify-content-evenly">
            <button type="button" class="btn btn-outline-primary btn-sm cpcnoprint" data-bs-toggle="offcanvas" data-bs-target="#formbalanco_conta_natureza" aria-controls="formbalanco_conta_natureza">
            ...
            <div class="input-group justify-content-center">
                    ...
                    <input type="text" name="buscar" id="buscar" class="form-control form-control-sm cpcnoprint" onkeyup="filtraTabela($(this).val(),'balanco_conta_natureza')" placeholder="Pesquisar..." style="min-width:200px; max-width:800px">
            </div>
...
<form id="formbalanco_conta_natureza" name="formbalanco_conta_natureza" action="." method="post" class="btn-group d-flex justify-content-between mb-3 offcanvas offcanvas-start" role="group" aria-label="Button group with nested dropdown" tabindex="-1" aria-labelledby="offcanvasLabel">
    <input type="hidden" name="tipodml" value="balanco_conta_natureza">
    ...
    <div class="offcanvas-body">
        ...
        <div class="row m-2" role="group">
            ...
            <select class="form-select cpcsave" name="status" id="status_filtro">
                <option>Todos</option>
        ...
        <div class="mt-4 d-flex justify-content-center">
            <button class="btn btn-outline-success w-100" id="balanco_conta_natureza" onclick="sqlitem($('#formbalanco_conta_natureza'),'financeiro/relatorios/balanco_conta_natureza','cpcMain');">Atualizar</button>
        </div>
    </div>
</form>

<div id="cpc-autoheight" style="overflow: auto;">
    <table id="balanco_conta_natureza" class="table table-hover table-sm tabelareport" style="min-width:1440px">
        <thead class="mb-3 tabelahead">
            <tr class="text-start text-muted fw-bold fs-7 gs-0">
                <th>Conta</th>
                <th class="text-end">Natureza</th>
                <th>Descrição</th>
        ...
        <tbody id="cpc-autoheightgrid" class="text-gray-600 tabelabody">
            <?
                ...
                $sql = "select financeirogeral.custos, custos.a_nome as descricao, CONTAS.A_NOME AS CONTA, ".
            ...
            ?>
            <tr>
                <td><? echo $row['CONTA'] ?></td>
                <td class="text-end"><? echo $row['CUSTOS'] ?></td>
                ...
                <td class="text-end"><? $saldo = $row['PAGAMENTO'] - $row['RECEBIMENTO']; if ($saldo) { $total += $saldo; echo number_format($saldo, 2,',','.'); } ?></td>
...
<div class="loadcpc" onclick="
  ...
  $('#formbalanco_conta_natureza').offcanvas('show');
"></div>
<? } ?>