    ...
    <div class="row card-head h3 text-center mt-1">
        <div class="col-12 d-flex justify-content-evenly">
            <div class="input-group text-center">
                ...
                <select id="abaitem" name="abaitem" value="aba-dados" class="form-select form-select-aba form-select-sm border border-primary fw-bold text-center text-primary cpcnoupdate select-cpc-abas" onfocusout="$(this).attr('size','1')" onchange=" $('.cpc-abas-padrao').show();
                                                                                                                                                                                                                                              $('.cpc-abas').hide();
    ...
    <form id="formcpr1" name="formcpr1" action="financeiro/dml.php" class="row g-1" enctype="multipart/form-data" method="post">
        ...
        <div class="row g-1 cpc-abas aba-cad aba-imposto" style="display:none">
            ...
            <div class="col-md-2">
                ...
                <input id="resultado" name="resultado" type="text" class="form-control travado" value="" default="0" style="text-align:right;"  readonly tipocpc="moeda" tabindex="-1">
            </div>
        </div>
